    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-8 md:py-10 text-center">
        ...
        <div className="mt-10 flex justify-center">
          ...
          >
            <span className="font-bold mr-6">Works with</span>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
          <button className="flex items-center gap-3 px-6 py-3 rounded-xl bg-gray-900 text-white font-semibold">
            <img
          ...
          <button className="px-8 py-3 rounded-xl bg-lime-400 text-gray-900 font-semibold hover:bg-lime-500 transition">
